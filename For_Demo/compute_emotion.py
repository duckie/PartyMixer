...
model_filename = r'model/all_jemo_384_features_2_classes'
...
def launchOneTesting_bin(filename) :
    ...
    cmdline = '%s %s %s %s' % \
        ('svm-predict',#svm_bin_dir + os.path.sep + 'svm-predict',
         filename + '.libsvm.scale',
