...
all_styles = ['jazz','funk','rock','disco','electro','fusion','lounge','ambient','classic rock','dub','metal','ska','soul','techno','trance']
...
def process_server_results():
    ...
    used_data = {"danceability": min_d , "spotify-ids": songs, "previous_styles": styles, "weighted_styles":weighted_styles}
